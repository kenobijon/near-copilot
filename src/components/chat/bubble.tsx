...
export default function Bubble({
  ...
  if (sourcesIndex !== -1 && message.role === "assistant") {
    ...
    messageWithOutSources = message?.content.substring(0, sourcesIndex - 9);
    messageId = Number(message?.content.substring(sourcesIndex - 9, sourcesIndex).trim());
  ...
  return (
    <div
      key={message.id}
      className={`flex flex-col items-center border-none ${message.role === "user"
